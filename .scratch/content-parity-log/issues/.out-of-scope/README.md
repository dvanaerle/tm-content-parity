...
A ticket in this folder is closed `wontfix`. It is kept, not deleted, because the
measurement in it is evidence and because most of these carry a **re-open
trigger** — the condition that would make the number worth looking at again.
...
Made on 2026-08-07 by the triage of the open tail, for ticket 49.
